...
| M8 | Complete on 2026-08-30; canonical traceability/ABI correction applied; ARM64 execution carried to M9 | `docs/milestones/m08-closeout.md`, `docs/milestones/m08-work-log.md` |
| M9 | Active on 2026-08-30; controlled requirements `0074`--`0077` established | `docs/milestones/m09-plan.md`, `docs/milestones/m09-work-log.md` |
...
and controlled evidence completed without a scope change. ARM64 execution and
the PE resource were initially carried to M9; the later canonical-traceability
correction implemented the resource, leaving ARM64 execution in the M9 matrix.
No downstream estimate crossed its
