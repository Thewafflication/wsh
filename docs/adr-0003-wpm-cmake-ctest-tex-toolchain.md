...
WPM will provision pinned WCRT, KerTeX, and cv2pdb packages. CMake presets will
describe architecture and configuration. CTest will dispatch every automated
